...
class Appointments_List_Table extends WP_List_Table {
    ...
    function __construct(){
        ...
        parent::__construct( array(
            'singular'  => 'afspraak',     //singular name of the listed records
            'plural'    => 'afspraken',    //plural name of the listed records
    ...
    function extra_tablenav( $which ) {
    	if ( $which == "top" ){
    		...
    		echo "Selecteer hieronder de afspraak die je wil betalen.";
    	}
    	if ( $which == "bottom" ){
    		//The code that goes after the table is there
    		//echo"Hi, I'm after the table";
    		echo sprintf('<br><a href="?page=%s">Overzicht betalingen</a>','alltransactions');
...
function tt_render_list_page(){
    ...
    $apptable = new Apppointments_List_Table();
